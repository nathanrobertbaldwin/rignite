...
def seed_photos():
    ...
    photo3 = Photo(
        product_id=1, url="https://i.ytimg.com/vi/SjBsWYWyoNk/maxresdefault.jpg"
    )
    ...
    photo18 = Photo(
        product_id=5, url="https://m.media-amazon.com/images/I/713bgPy0HeL.jpg"
    )
    ...
    photo25 = Photo(
        product_id=7, url="https://m.media-amazon.com/images/I/51KZcUQIyiS.jpg"
    )

    photo26 = Photo(
        product_id=7, url="https://m.media-amazon.com/images/I/51Lv97GAWZL._AC_.jpg"
    )

    photo27 = Photo(
        product_id=7, url="https://m.media-amazon.com/images/I/51YA8loHVFL._AC_.jpg"
    )

    photo28 = Photo(
        product_id=7, url="https://m.media-amazon.com/images/I/51zjERz4rEL._AC_.jpg"
    )
